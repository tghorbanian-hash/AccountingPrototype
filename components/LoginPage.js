...
const LoginPage = ({ 
  ...
  // رفع باگ: اطمینان از مقداردهی اولیه برای جلوگیری از خطای "Cannot read properties of undefined"
  const safeLoginData = loginData || { identifier: '', password: '' };
  const safeRecoveryData = recoveryData || { otp: '' };
          ...
          <form onSubmit={handleVerifyOtp} className="space-y-5 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div>
              ...
              <input 
                ...
                autoFocus
                required
                value={safeRecoveryData.otp}
                onChange={(e) => setRecoveryData({...safeRecoveryData, otp: e.target.value})}
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input 
                    ...
                    required
                    value={safeLoginData.identifier}
                    onChange={(e) => setLoginData({...safeLoginData, identifier: e.target.value})}
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input 
                    type="password"
                    required
                    value={safeLoginData.password}
                    onChange={(e) => setLoginData({...safeLoginData, password: e.target.value})}
                    className={`w-full bg-slate-50 border border-slate-200 rounded-xl py-3 ${isRtl ? 'pr-12 pl-4' : 'pl-12 pr-4'} outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-50 transition-all text-sm`}
                    placeholder="••••••••"
                  />
                </div>
