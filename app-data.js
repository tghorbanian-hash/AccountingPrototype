...
window.translations = {
  en: {
    ...
    searchUserPlaceholder: 'Search by username, name or role...',
    filter: 'Filter',
    colUser: 'User',
    ...
    editing: 'Editing',
    newUserSubtitle: 'Fill in the information below to add a new user',
    formUnderDev: 'Form Under Construction',
    formUnderDevDesc: 'The detailed form fields for user creation/editing will be implemented in the next phase.',
    cancel: 'Cancel',
  ...
  fa: {
    ...
    searchUserPlaceholder: 'جستجو بر اساس نام کاربری، نام یا نقش...',
    filter: 'فیلتر',
    colUser: 'کاربر',
    colFullName: 'نام و نام خانوادگی',
    colStatus: 'وضعیت',
    colActions: 'عملیات',
    statusActive: 'فعال',
    ...
    newUserSubtitle: 'برای افزودن کاربر جدید، اطلاعات زیر را تکمیل کنید',
    formUnderDev: 'فرم در دست ساخت',
    formUnderDevDesc: 'فیلدهای دقیق مربوط به تعریف و ویرایش کاربر در فاز بعدی پیاده‌سازی خواهد شد.',
    cancel: 'انصراف',
